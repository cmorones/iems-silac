...
/**
 * InvetarioLabSearch represents the model behind the search form about `app\models\InvetarioLab`.
 */
class InvetarioLabSearch extends InvetarioLab
{
    /**
     * @inheritdoc
     */
