...
<li class="treeview active">
	<?= Html::a('<i class="fa fa-graduation-cap"></i> <span>Administracion</span> <i class="fa fa-angle-left pull-right"></i>', ['/student/default/index'])  ?>
        <ul class="treeview-menu">
	<?php if(Yii::$app->user->can('/course/courses/index')) { ?>
            <li>
		<?= Html::a('<i class="fa fa-angle-double-right"></i> '.Yii::t('course', 'Materiales'),['/course/courses/index'])  ?>
	    </li>
	<?php } 
