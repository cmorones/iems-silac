...
<div class="login-box">
    ...
    <h1><?= Html::img(Yii::$app->request->baseUrl.'/images/logo.png', ['width'=>'250px;']) ?></h1>
      </div>
      <div class="login-box-body">
    
        <p class="login-box-msg"><?php echo Yii::t('app', 'Sistema de Información para los laboratorios de Ciencias del IEMS (SILAC)') ?></p>
