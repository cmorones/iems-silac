...
$( document ).ready(function() {
	$('#<?php echo Html::getInputId($model, "imagen"); ?>').bootstrapFileInput();
...
<div class="col-xs-12 col-lg-12">
  <div class="box box-info box-solid view-item col-xs-12 col-lg-12 no-padding">
   <div class="box-header with-border">
         <h4 class="box-title"><i class="fa fa-picture-o"></i>&nbsp; Foto del Material
   </div>
   <div class="box-body">
	...
	<?php echo Html::img($model->getMatPhoto($model->imagen), ["width"=>"150px", "height"=>"150px", 'alt'=>'No Image', 'id'=>'aImgShow']); ?>  
    </div>

      <div class="col-xs-12 col-sm-12 col-lg-12 text-center no-padding"> 
	<?= $form->field($model,'imagen')->fileInput(['data-filename-placement' => "inside", 'title' => 'Buscar Foto', 'onchange'=>'uploadImage(this)', 'data-target'=>'#aImgShow']) ?>
    </div>

    <div class="hint col-xs-12 col-sm-12" style="color:red;padding-top:15px"><b>Nota:- </b>&nbsp;Solo archivos tipo: Jpeg, Jpg, Png, Gif 
    </div>
 
    <div class="form-group col-xs-12 col-sm-12 no-padding edusecArLangCss">
	<hr>
        <?= Html::submitButton($model->isNewRecord ? 'Agregar' : 'Modificar', ['class' => $model->isNewRecord  ? 'btn btn-success' : 'btn btn-info']) ?>
    </div>
    <?php ActiveForm::end(); ?>   
