...
<!--
		   ...
		   <?php if ($cv->status==2) { ?>
			...
			?>
				 <?= Html::a('<i class="fa fa-pencil-square-o"></i>', ['/docente/sesiones', 'id'=>$cv->secuencia, 'nombre'=>$cv->nombre], ['class'=>'btn-sm btn btn-default', 'title'=>Yii::t('app', 'Segumiento de Sesion')]) ?>
			<?php
				}
			?>
